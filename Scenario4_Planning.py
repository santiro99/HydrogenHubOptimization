...
def run_planning(LCOH_c, LCOE_r, LCOS, Xc_prev=None):
    ...
    def total_cost_rule(model):
        ...
        carbon_price_per_kg = 0.1  # USD/kg of H2 from SMR
        ...
        smr_carbon_cost = sum(model.X_c['SMR', y] * model.eta['SMR'] * model.hours_per_year * carbon_price_per_kg * 0 for y in model.Y)
        return conv_cost + energy_cost + storage_cost + emission_cost + smr_carbon_cost +  penalty_weight * model.Penalty
